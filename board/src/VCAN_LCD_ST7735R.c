...
void    LCD_ST7735R_init()
{
	  ...
	  GPIO_InitTypeDef  GPIO_InitStructure;
		...
		GPIO_InitStructure.GPIO_Pin = (0X1FF<<7);         //PE7~15,推挽输出
		...
		GPIO_InitStructure.GPIO_Pin = GPIO_Pin_5|GPIO_Pin_7;         //PA5,7,推挽输出
		GPIO_Init(GPIOA, &GPIO_InitStructure);            //初始化 
		
		GPIO_InitStructure.GPIO_Pin = GPIO_Pin_0;         //PB0,推挽输出
